...
function ProductList(props){
    ...
    return(
        <>
            <h2 className="text-center mb-3 pb-3">List Products</h2>
                                ...
                                return(
                                    <tr key={App}>
                                        ...
                                        <td style={{width: "10px", whiteSpace: "nowrap"}}>
                                            <button type="button" onClick={() => props.showForm(product)} className="btn btn-success btn-sm me-2">Edit</button>
                                            <button type="button" onClick={() => deleteProduct(product.id)} className="btn btn-danger btn-sm me-2">Delete</button>
                                        </td>
                                    </tr>
                                );
                            })
